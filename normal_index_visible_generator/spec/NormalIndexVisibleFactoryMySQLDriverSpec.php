...
class NormalIndexVisibleFactoryMySQLDriverSpec extends ObjectBehavior
{
    ...
    function it_can_create_test_table ()
    {
        $this->connect();
    ...
    {
        $this->shouldHaveType('NormalIndexVisibleFactoryMySQLDriver');
    ...
    {
        $this->shouldImplement('NormalIndexVisibleFactoryDriverInterface');
    ...
    {
        $this->setTable('normal_index_visible_test');

    }


    function it_should_return_boolean_on_truncate ()
    {
        $this->connect();
        $this->setTable('normal_index_visible_test');
    ...
    function it_should_insert_data() {
        $data = array();
    ...
    function it_can_drop_test_table ()
    {
        $this->connect();
